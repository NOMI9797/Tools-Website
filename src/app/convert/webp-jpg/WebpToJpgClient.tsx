  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        alert('Failed to convert image. Please ensure the file is a valid WEBP image.');
      }
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <div className="bg-transparent">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Input Section */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Convert WEBP to JPG</h3>
        ...
        <div>
          ...
          {convertedImage ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-200/50 border border-gray-300/50 rounded-xl p-8 text-center backdrop-blur-sm">
                ...
                <p className="text-gray-700">
                  Your WEBP image is ready to be converted to JPG format.
                </p>
              </div>
            </div>
          ) : (
            <div className="bg-gray-200/50 border border-gray-300/50 rounded-xl p-8 text-center backdrop-blur-sm">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Ready to Convert</h4>
              <p className="text-gray-700">
                Select a WEBP image file to start conversion to JPG format.
              </p>
            </div>
          )}
        </div>
