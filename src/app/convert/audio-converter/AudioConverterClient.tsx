...
export default function AudioConverterClient() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile) {
      if (!ALLOWED_MIME_TYPES.includes(selectedFile.type) && !selectedFile.name.match(/\.(mp3|wav|ogg|flac|aac|m4a|wma)$/i)) {
        setError('Please select a valid audio file (MP3, WAV, OGG, FLAC, AAC, M4A).');
        return;
      }
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-700">
          Transform your audio files between MP3, WAV, OGG, FLAC, AAC, and M4A formats
        </p>
      </div>
      ...
      <div className="bg-transparent p-8">
        <div className="space-y-6">
          ...
          >
            ...
            <div className="text-sm text-gray-600">Supports: MP3, WAV, OGG, FLAC, AAC, M4A</div>
