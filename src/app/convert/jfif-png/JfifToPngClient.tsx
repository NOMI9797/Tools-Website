...
export default function JfifToPngClient() {
  ...
  const handleDownload = useCallback(() => {
    ...
    link.download = file?.name.replace(/\.jfif$/i, '.png') || 'converted.png';
    ...
    <div className="grid gap-6 md:grid-cols-[1fr_320px]">
      <div className="rounded-xl border border-black/[.06] bg-white p-6 space-y-4">
        <div className="space-y-2">
          <label className="text-sm font-medium">Upload JFIF</label>
          <input
            type="file"
            accept=".jfif"
        ...
        {preview && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <p className="text-sm text-black/70">Original JFIF</p>
            </div>
