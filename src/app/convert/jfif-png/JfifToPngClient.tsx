...
export default function JfifToPngClient() {
  ...
  const handleFileChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file.name.toLowerCase().endsWith('.jfif')) {
      alert('Please select a JFIF image file (with .jfif extension)');
      return;
    }
  ...
  return (
    <div className="bg-transparent">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Input Section */}
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Convert JFIF to PNG</h3>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="text-gray-700">
                    {file ? file.name : "Click to select JFIF file"}
                  </div>
                  <div className="text-sm text-gray-600 mt-1">
                    Supports: JFIF format only (.jfif extension)
                  </div>
                </button>
              </div>
        ...
        <div>
          ...
          {convertedImage ? (
              ...
              <div className="bg-gray-200/50 border border-gray-300/50 rounded-xl p-4 backdrop-blur-sm">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    ...
                    <div className="font-medium text-gray-900">JFIF</div>
                  </div>
                  <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-200/50 border border-gray-300/50 rounded-xl p-6 backdrop-blur-sm">
                <h4 className="font-semibold text-gray-900 mb-3">Original JFIF Preview</h4>
                <div className="flex justify-center">
                  {preview ? (
                    <img
                      src={preview}
              ...
              <div className="bg-gray-200/50 border border-gray-300/50 rounded-xl p-8 text-center backdrop-blur-sm">
                ...
                <p className="text-gray-700">
                  Your JFIF image is ready to be converted to PNG format.
                </p>
              </div>
            </div>
          ) : (
            <div className="bg-gray-200/50 border border-gray-300/50 rounded-xl p-8 text-center backdrop-blur-sm">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Ready to Convert</h4>
              <p className="text-gray-700">
                Select a JFIF image file to start conversion to PNG format.
              </p>
            </div>
          )}
        </div>
